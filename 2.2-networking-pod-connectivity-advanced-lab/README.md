...
Please note that you can also get IPPool information using `kubectl` instead of `calicoctl` in the previous. In you use Openshift, you can replace `calicoctl` with `oc`.
